dojo.declare("zwei/gfx/chart/Node", null, {
	component: null,
	...
	menu : function() {
		...
		var self = this;
		require([ 'dijit/Menu', 'dijit/MenuItem', 'dijit/MenuSeparator', 'zwei/Form'], function(Menu, MenuItem, MenuSeparator, Form) {
	...
	add: function(data, pathsId, id, x1, y1) {
		var self = this;
		dojo.require(['zwei/gfx/ZoomMover', 'dojox/gfx/Moveable'], function(ZoomMover, Moveable){
