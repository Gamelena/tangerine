dojo.declare("zwei.gfx.FlowChart", null, {
	id: null,
	surface: null,
	domPrefix: null,
	group: null,
	...
	addNode: function(data, x1, y1) {
		var self = this;
		require(['zwei/gfx/chart/Node'], function(Node){
	...
	{
		var self = this;
		require(['zwei/gfx/chart/Connector'], function(Connector){
