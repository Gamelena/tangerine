...
class Gamelena_Admin_Xml extends Gamelena_Utils_SimpleXML
{
    /**
     * Obtiene el path completo del archivo xml, según las convenciones de tangerine,
     ...
     * @param string $root
     * @param string $toXml
     * @return <multitype:, Gamelena_Admin_Xml, SimpleXMLElement>
     */
     ...
     * 
     * @param array $array
     * @return Gamelena_Admin_Xml
     */
    public function parseXml($array) 
    {
        $xml = Gamelena_Utils_Array::toXml($array, new Gamelena_Admin_Xml("<?xml version=\"1.0\"?><components></components>"));
        return $xml;
    }
    
    /**
     * @param string               $index
     * @param Gamelena_Utils_SimpleXML $son
     * @param Gamelena_Utils_SimpleXML $father
     */
