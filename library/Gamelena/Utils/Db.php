...
class Gamelena_Utils_Db
{
    ...
    public static function getRotatedTables($from, $to, $whereAlias, $prefix, $interval = "days", Zend_Db_Table_Abstract $table=null)
    {
        ...
        if (!is_null($from) && !is_null($to)) {
            ...
            $interval = Gamelena_Utils_Time::createInterval(
                Gamelena_Utils_Time::datetimeToTimestamp($from),
                Gamelena_Utils_Time::datetimeToTimestamp($to),
                $interval
            );
