...
class Gamelena_Ftp_Directory
{
     ...
     * @param  Gamelena_Ftp $ftp  The FTP connection
     * @return
     */
     ...
     *
     * @return Gamelena_Ftp_Iterator
     */
    public function getContents()
    {
        if ($this->_contents === null) {
            $this->_changeToDir();
            $this->_contents = new Gamelena_Ftp_Directory_Iterator($this->_path, $this->_ftp);
        }
    ...
    public function put($localFilepath, $remoteFilepath, $mode = null, $remoteFilename = null)
    {
        ...
        $file = new Gamelena_Ftp_File($remoteFilepath, $this->_ftp);
    ...
    {
        return new Gamelena_Ftp_File($this->_path . '/' . $filename, $this->_ftp);
    }
    ...
    {
        return new Gamelena_Ftp_Directory($this->_path . '/' . $filename, $this->_ftp);
    }
