<?php class Gamelena_Ftp_Princ
{
    ...
    */
    ...
    protected function _connect()
    {
        ...
        $apikeys = $config->getOption('gamelena');
    ...
    public function getDirectory($filename = '')
    {
        ...
        return new Gamelena_Ftp_Directory($filename, $this);
    }
    ...
    public function getFile($filename)
    {
        ...
        return new Gamelena_Ftp_File($filename, $this);
    }
    ...
    public function getCurrentDirectory()
    {
        if ($this->_currentDirectory === null) {
            ...
            $this->_currentDirectory = new Gamelena_Ftp_Directory($this->_currentPath, $this);
        }
