...
class Gamelena_Ftp_Directory_Iterator implements SeekableIterator, Countable, ArrayAccess
{
    /**
     * The directory
     *
    ...
    */
     ...
     *
     * @return Gamelena_Ftp_Directory_Iterator
     */
     ...
     *
     * @return Gamelena_Ftp_Directory|Zend_Ftp_File|null
     */
    public function current()
    {
        ...
        if (empty($this->_rows[$this->_pointer])) {
            ...
            switch ($row['type']) {
            case 'd': // Directory
                $this->_rows[$this->_pointer] = new Gamelena_Ftp_Directory($this->_dir . $row['name'] . '/', $this->_ftp);
                break;
            case '-': // File
