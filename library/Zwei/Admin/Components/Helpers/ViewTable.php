    ...
    function display()
    {
        ...
        for($i=0; $i<$vcount; $i++){
            ...
            if(isset($this->layout[0]['EDIT']) && $this->layout[0]['EDIT']=="true"){
                $out.="<a id=\"c_edit{$i}\" href=\"javascript:void(0)\" onclick=\"edit($i,$count,'$this->page')\" title=\"Edit\"><img src=\"".BASE_URL."images/admin/32/pencil.png\" alt=\"Editar\"  /></a><img id=\"loading{$i}\" src=\"".BASE_URL."images/admin/loading.gif\" style=\"display:none\" /><a style=\"display:none\" id=\"c_update{$i}\" href=\"javascript:void(0)\" onclick=\"update($i,$count)\" title=\"Save\"><img src=\"".BASE_URL."images/admin/accept.png\" alt=\"Aceptar\" /></a> <a style=\"display:none\" id=\"c_cancel{$i}\" href=\"javascript:void(0)\" onclick=\"cancel($i,$count)\" title=\"Cancel\"><img src=\"".BASE_URL."images/admin/cancel.png\" alt=\"Cancelar\" /></a>";
            ...
            if(isset($this->layout[0]['DELETE']) && $this->layout[0]['DELETE']=="true"){
                $out.=" <a href=\"javascript:void(0)\" onclick=\"if(confirm('¿Estás Seguro?')==true){dojo_panel_central.set('href','{$_SERVER['REQUEST_URI']}&a=delete&{$this->layout[1]['TARGET']}[]=$id')}\" title=\"Delete\"><img src=\"".BASE_URL."images/admin/32/record-delete.png\" alt=\"Borrar\" /></a></td>";
            }
            $out.="</tr>\r\n";
        }
        $out.="</table>";
