...
class Zwei_Ftp_Directory
{
	 ...
	 * @param Zwei_Ftp $ftp The FTP connection
	 * @return
	 */
	 ...
	 *
	 * @return Zwei_Ftp_Iterator
	 */
	public function getContents()
	{
		if ($this->_contents === null) {
			$this->_changeToDir();
			$this->_contents = new Zwei_Ftp_Directory_Iterator($this->_path, $this->_ftp);
		}
	...
	{
		return new Zwei_Ftp_File($this->_path . '/' . $filename, $this->_ftp);
	}
	...
	{
		return new Zwei_Ftp_Directory($this->_path . '/' . $filename, $this->_ftp);
	}
