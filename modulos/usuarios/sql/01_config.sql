...
INSERT INTO `mantenedor_permisos` ( `id_mant`, `id_perfil` ) select mantenedor_mantenedores.id, usuarios_perfiles.id from mantenedor_mantenedores, usuarios_perfiles where usuarios_perfiles.nombre = 'admin' and mantenedor_mantenedores.nombre = 'usuarios';
INSERT INTO `mantenedor_permisos` ( `id_mant`, `id_perfil` ) select mantenedor_mantenedores.id, usuarios_perfiles.id from mantenedor_mantenedores, usuarios_perfiles where usuarios_perfiles.nombre = 'admin' and mantenedor_mantenedores.nombre = 'perfiles';
INSERT INTO `mantenedor_permisos` ( `id_mant`, `id_perfil` ) select mantenedor_mantenedores.id, usuarios_perfiles.id from mantenedor_mantenedores, usuarios_perfiles where usuarios_perfiles.nombre = 'admin' and mantenedor_mantenedores.nombre = 'roles';

INSERT INTO `mantenedor_multiple` ( `nombre`, `url` ) VALUES ( 'perfiles', '/admportal/modulos/usuarios/web/ctrl/perfiles.php' );
INSERT INTO `mantenedor_multiple` ( `nombre`, `url` ) VALUES ( 'estado_usr', '/admportal/modulos/usuarios/web/ctrl/estadousr.php' );

 
INSERT INTO `mantenedor_campos` ( `id_mant`, `id_tipo`, `nombre`, `etiqueta`, `hint`, `id_multiple`, `fijo` )
	select mantenedor_mantenedores.id, mantenedor_tipos.id, 'id', 'Id', '', 0, false
...
INSERT INTO `mantenedor_campos` ( `id_mant`, `id_tipo`, `nombre`, `etiqueta`, `hint`, `id_multiple` )
...
INSERT INTO `mantenedor_keys` ( `id_mant`, `id_campo` )
	select mantenedor_mantenedores.id, mantenedor_campos.id
	FROM mantenedor_mantenedores, mantenedor_campos WHERE 
	mantenedor_mantenedores.nombre = 'usuarios' AND 
	mantenedor_campos.nombre = 'id' AND 
	mantenedor_campos.id_mant = mantenedor_mantenedores.id;
...
INSERT INTO `mantenedor_campos` ( `id_mant`, `id_tipo`, `nombre`, `etiqueta`, `hint`, `id_multiple`, `fijo` )
	select mantenedor_mantenedores.id, mantenedor_tipos.id, 'login', 'Login usuario', '', 0, false
	FROM mantenedor_mantenedores, mantenedor_tipos WHERE 
	mantenedor_mantenedores.nombre = 'roles' AND mantenedor_tipos.nombre = 'field';

INSERT INTO `mantenedor_campos` ( `id_mant`, `id_tipo`, `nombre`, `etiqueta`, `hint`, `id_multiple` )
	select mantenedor_mantenedores.id, mantenedor_tipos.id, 'perfiles', 'Estado del usuario', '', mantenedor_multiple.id
	FROM mantenedor_mantenedores, mantenedor_tipos, mantenedor_multiple WHERE 
