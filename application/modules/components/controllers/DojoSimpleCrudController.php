...
class Components_DojoSimpleCrudController extends Zend_Controller_Action
{
    ...
    public function listAction()
    {
        ...
        $pagination = !Zwei_UserAgent::isMobile() ? "pagination: {defaultPageSize:25, maxPageStep: 5, sizeSwitch: true, id: '{$this->view->domPrefix}gridPaginator', style: {position: 'relative'}}" : '';
